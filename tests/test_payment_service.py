...
async def test_process_successful_topup_payment(mock_supabase):
    ...
    with pytest.MonkeyPatch.context() as m:
        ...
        m.setattr("app.services.payment_service.log_audit_event", lambda *args, **kwargs: None)
        ...
        await process_successful_topup_payment("TOPUP-123", {"flw_ref": "abc"}, mock_supabase)
